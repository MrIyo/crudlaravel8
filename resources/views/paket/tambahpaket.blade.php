...
@section('content')
    ...
    <body>
        <br>
        <h1 class="text-center mb-3 mt-5">Tambah Paket Kendaraan</h1>
        <div class="container mb-5">
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/insertdatapaket" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="sejak" class="form-control">
                                    <br>
                                    <label for="exampleInputEmail1" class="form-label">Sampai</label>
                                    <input type="datetime-local" name="sampai" class="form-control">
                                </div>
