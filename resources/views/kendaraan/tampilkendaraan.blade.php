...
@section('content')
    ...
    <body>
        <br>
        <h1 class="text-center mb-3 mt-5">Edit Jenis Kendaraan</h1>
        <div class="container mb-5">
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <form action="/updatekendaraan/{{ $data->id }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="jenis_kendaraan" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" value="{{ $data->jenis_kendaraan }}">
