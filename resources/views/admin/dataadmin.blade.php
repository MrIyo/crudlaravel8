                ...
                <tbody>
                    ...
                    @foreach ($data as $index => $admin)
                        <tr>
                            ...
                            <td>{{ $admin->kendaraans->jenis_kendaraan }}</td>
                            {{-- <td>{{ $admin->id_kendaraan }}</td> <!-- = langsung memanggil id --> --}}
                            <td>{{ $admin->plat_nomor }}</td>
                            <td>
                                <img src="{{ asset('fotoadmin/' . $admin->foto) }}" alt="" style="width: 40px; height: 40px;">
                            </td>
                            <td>{{ $admin->email }}</td>
